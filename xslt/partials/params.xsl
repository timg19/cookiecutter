...
<xsl:stylesheet 
    ...
    <xsl:param name="directory_name">cookiecutter</xsl:param>
    <xsl:param name="project_title">Static Site Cookiecutter</xsl:param>
    <xsl:param name="redmine_id">18716</xsl:param>
    <xsl:param name="project_short_title">staticsite</xsl:param>
